...
test$tost.p.value
```
The output can be interpreted similarly to a standard hypothesis test, therefore from the p-value we conclude that the two means are not equivalent, we __reject the alternative hypothesis__.
...
test$tost.p.value
```
The output can be interpreted similarly to a standard hypothesis test, therefore from the p-value > 0.05 we conclude that the two means are not equivalent, we __reject the alternative hypothesis__.
